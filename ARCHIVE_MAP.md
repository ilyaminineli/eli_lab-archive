...
> Working master map for the multidisciplinary archive.
> Last research pass: 2026-09-22
>
> This file is more inclusive than the public-facing website. It is a research ledger: confirmed works, source repositories, external traces, unresolved records, and material that still needs provenance checks.
...
- CGI / 3D / Blender
- animation / experimental film / music video
- interactive archives / websites / software
- game experiments
- creative technology / generative audio / procedural systems
- collaborations / performances / exhibition-related work
- archival and research-oriented projects
...
- eli_lab_mv
- eli_lab-mv-titler
- eli_lab-blender-scripts
- eli_lab_organiser
- eli_lab_comfy
- word_doc_filler
- payment-bot — unrelated client/service work; do not ingest as artwork without further context
- template_repository
...
- Lab Announcement 3
- life in one second
- Live in One Gog Center 2021
- Redux To The Breath - Part 2
- rakkaani
- amp
- patanormal
...
- eli_lab Multimedia Framework — production and archive infrastructure
...
- Photoseries
- Single Photos
- Jewish gift / A gift to a Jewish fund
...
- images/CG Design Ilya Minin (Eli)/
- images/CG For Site/
...
A Voices.com result for an Ilya Minin in Kfar Saba contains voice-acting commercial demos. Identity could not be established as the artist in this archive research.

**Do not ingest this profile without independent confirmation.**
...
- candidate — probable connection requiring checking
- private — source exists but should not be published
- excluded — collision or irrelevant material
...
- EWP Project
- Bogorodskoe
- Untitled 3 / Без названия 3
- A gift to a Jewish fund
- Lab Announcement 3
- Geztålt releases
- Eugene
- Iirai / Akane Iirai
...
- performances
- exhibitions
- older audio releases
- historical ELIAS ADAMS material

## 13. Design research for the new archive
...
- dark engraved technical labels
- small tick marks
- red indicator lamps
- screws / fasteners
...
4. Release platform
5. Secondary documentation
6. Search result snippets
7. Social reposts / nickname directories
...
- extract dates, collaborators, locations and materials from old pages
- enumerate Bandcamp releases completely
- verify exhibitions, screenings and performances
